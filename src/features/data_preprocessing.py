...
# set the transformers output to pandas
...
def drop_missing_values(data:pd.DataFrame) ->pd.DataFrame:
    ...
    logger.info(f"The original data set and missing value has {data.shape[0]} rows and{data.shape[1]} columns")
